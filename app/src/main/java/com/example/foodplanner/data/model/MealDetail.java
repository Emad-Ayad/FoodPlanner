...
public class MealDetail {
    ...
    public List<IngredientItem> getIngredients() {
        ...
        try {
            for (int i = 1; i <= 20; i++) {
                Field ingField = getClass().getDeclaredField("ingredient" + i);
                Field meaField = getClass().getDeclaredField("measure" + i);

                ingField.setAccessible(true);
                meaField.setAccessible(true);

                String ingredient = (String) ingField.get(this);
                String measure = (String) meaField.get(this);

                if (ingredient != null && !ingredient.trim().isEmpty()) {
                    list.add(new IngredientItem(ingredient.trim(),
